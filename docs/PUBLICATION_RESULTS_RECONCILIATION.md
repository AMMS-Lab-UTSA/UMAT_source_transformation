...
| SoftwareX Table 6: parameter sensitivities across 18 models | 18 models; "76 of 84 directions" | **18/18 models attempted, contracts generated, transformed and compiled. 76 parameter directions declared. 0 executed, 0 numerically verified.** | `paper_results/parameter_sensitivity/{parameter_sensitivity_round.json,table6_parameter_sensitivity.csv}` | `partially_implemented` | **The 76 is real and reproduced** — it is the count of declared parameter directions across the 18 models, measured, not asserted. But **76 verified directions is not yet true**: nothing has been executed or checked against a reference. Publish the funnel (18 compiled, 0 verified), never the bare 76 |
