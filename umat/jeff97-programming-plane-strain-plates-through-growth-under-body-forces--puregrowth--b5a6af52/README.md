# jeff97-programming-plane-strain-plates-through-growth-under-body-forces--puregrowth--b5a6af52

`Jeff97__Programming-Plane-Strain-Plates-through-Growth-Under-Body-Forces/Examples-In-Section-3/ParabolicDown/Th002/PureGrowth.for`
...
- **Stress and state history**: agreed to 1.679e-12 on stress and 0.000e+00 on state, over 349 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 3 of 3 states along the loading path, worst 4.084e-08.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 0 | 1 | 1.024e-09 | agreed |
| 14 | 5 | 4.084e-08 | agreed |
| 29 | 10 | 9.474e-09 | agreed |
