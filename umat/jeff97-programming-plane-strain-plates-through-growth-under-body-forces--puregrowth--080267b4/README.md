# jeff97-programming-plane-strain-plates-through-growth-under-body-forces--puregrowth--080267b4

`Jeff97__Programming-Plane-Strain-Plates-through-Growth-Under-Body-Forces/Examples-In-Section-3/Flat/Th001/PureGrowth.for`
...
- **Stress and state history**: agreed to 0.000e+00 on stress and 0.000e+00 on state, over 2952 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 2 of 2 states along the loading path, worst 1.590e-10.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 3 | 4 | 1.590e-10 | agreed |
| 141 | 2 | 1.013e-10 | agreed |
