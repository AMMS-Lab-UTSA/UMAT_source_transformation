# jeff97-programming-plane-strain-plates-through-growth-under-body-forces--bodyforce-growth-2stages--940317e4

`Jeff97__Programming-Plane-Strain-Plates-through-Growth-Under-Body-Forces/Examples-In-Section-3/Flat/Th002-Visualization/BodyForce-Growth-2Stages.for`
...
- **Stress and state history**: agreed to 0.000e+00 on stress and 0.000e+00 on state, over 3520 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 2 of 2 states along the loading path, worst 3.643e-09.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 3 | 4 | 3.643e-09 | agreed |
| 161 | 2 | 1.823e-09 | agreed |
