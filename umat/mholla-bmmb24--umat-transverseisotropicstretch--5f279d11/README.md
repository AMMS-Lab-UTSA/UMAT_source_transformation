# mholla-bmmb24--umat-transverseisotropicstretch--5f279d11

`mholla__BMMB24/simulations/input files/umat_transverseIsotropicStretch.f`
...
- **Stress and state history**: agreed to 0.000e+00 on stress and 0.000e+00 on state, over 2240 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 2 of 2 states along the loading path, worst 7.297e-08.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 3 | 4 | 4.170e-08 | agreed |
| 81 | 2 | 7.297e-08 | agreed |
