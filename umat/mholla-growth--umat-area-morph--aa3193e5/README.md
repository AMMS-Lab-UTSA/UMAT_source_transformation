# mholla-growth--umat-area-morph--aa3193e5

`mholla__growth/umats/umat_area_morph.f`
...
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 3 of 3 states along the loading path, worst 2.740e-07.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 0 | 1 | 2.215e-10 | agreed |
| 14 | 5 | 2.740e-07 | agreed |
| 29 | 10 | 7.280e-11 | agreed |
