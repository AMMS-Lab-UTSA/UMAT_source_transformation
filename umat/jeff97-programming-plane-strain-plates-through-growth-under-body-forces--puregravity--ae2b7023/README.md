...
- **Stress and state history**: agreed to 9.314e-11 on stress and 0.000e+00 on state, over 2212 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 2 of 2 states along the loading path, worst 7.734e-11.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 3 | 4 | 7.734e-11 | agreed |
| 81 | 2 | 5.377e-11 | agreed |
