...
- **Stress and state history**: agreed to 6.756e-11 on stress and 0.000e+00 on state, over 3840 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 2 of 2 states along the loading path, worst 5.377e-11.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 3 | 4 | 5.156e-11 | agreed |
| 161 | 2 | 5.377e-11 | agreed |
