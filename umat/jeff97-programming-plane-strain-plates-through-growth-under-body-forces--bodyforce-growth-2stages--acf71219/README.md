# jeff97-programming-plane-strain-plates-through-growth-under-body-forces--bodyforce-growth-2stages--acf71219

`Jeff97__Programming-Plane-Strain-Plates-through-Growth-Under-Body-Forces/Examples-In-Section-3/Flat/Th001/BodyForce-Growth-2Stages.for`
...
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 3 of 3 states along the loading path, worst 2.131e-07.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 0 | 1 | 1.929e-10 | agreed |
| 10 | 1 | 2.131e-07 | agreed |
| 21 | 2 | 3.082e-08 | agreed |
