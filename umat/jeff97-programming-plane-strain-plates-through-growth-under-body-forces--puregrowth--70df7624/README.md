...
- **Stress and state history**: agreed to 2.064e-12 on stress and 0.000e+00 on state, over 1920 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 2 of 2 states along the loading path, worst 2.305e-07.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 3 | 4 | 2.305e-07 | agreed |
| 81 | 2 | 3.780e-11 | agreed |
