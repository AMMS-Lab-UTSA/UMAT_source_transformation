# mholla-growth--umat-transverse--f34d96fb

`mholla__growth/umats/umat_transverse.f`
...
- **Stress and state history**: agreed to 0.000e+00 on stress and 0.000e+00 on state, over 3232 resolved components.
