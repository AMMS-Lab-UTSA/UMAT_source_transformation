# jeff97-programming-plane-strain-plates-through-growth-under-body-forces--puregravity--e17c0dc7

`Jeff97__Programming-Plane-Strain-Plates-through-Growth-Under-Body-Forces/Examples-In-Section-3/ParabolicDown/Th005/PureGravity.for`
...
- **Stress and state history**: agreed to 3.186e-05 on stress and 0.000e+00 on state, over 2052 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 4 of 4 states along the loading path, worst 4.581e-09.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 0 | 1 | 3.402e-09 | agreed |
| 9 | 10 | 4.581e-09 | agreed |
| 22 | 3 | 3.398e-09 | agreed |
| 91 | 12 | 3.105e-09 | agreed |
