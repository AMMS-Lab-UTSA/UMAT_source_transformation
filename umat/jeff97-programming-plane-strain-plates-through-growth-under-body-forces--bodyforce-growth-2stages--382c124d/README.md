# jeff97-programming-plane-strain-plates-through-growth-under-body-forces--bodyforce-growth-2stages--382c124d

`Jeff97__Programming-Plane-Strain-Plates-through-Growth-Under-Body-Forces/Examples-In-Section-3/ArcDown/Th005-Visualization/BodyForce-Growth-2Stages.for`
...
- **Stress and state history**: agreed to 2.334e-05 on stress and 0.000e+00 on state, over 4200 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 2 of 2 states along the loading path, worst 3.663e-09.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 3 | 4 | 3.663e-09 | agreed |
| 161 | 2 | 2.878e-09 | agreed |
