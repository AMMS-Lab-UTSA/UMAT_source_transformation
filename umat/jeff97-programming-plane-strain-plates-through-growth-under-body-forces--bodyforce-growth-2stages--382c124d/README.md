...
- **Stress and state history**: agreed to 1.768e-11 on stress and 0.000e+00 on state, over 254 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 3 of 3 states along the loading path, worst 1.065e-07.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 0 | 1 | 1.929e-10 | agreed |
| 10 | 1 | 4.091e-08 | agreed |
| 21 | 2 | 1.065e-07 | agreed |
