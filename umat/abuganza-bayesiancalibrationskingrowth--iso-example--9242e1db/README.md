# abuganza-bayesiancalibrationskingrowth--iso-example--9242e1db

`abuganza__BayesianCalibrationSkinGrowth/Revision/Abaqus SImulation/SampleSimulation/Iso_Example.f`
...
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 2 of 2 states along the loading path, worst 1.141e-10.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 3 | 4 | 1.141e-10 | agreed |
| 141 | 2 | 1.119e-10 | agreed |
