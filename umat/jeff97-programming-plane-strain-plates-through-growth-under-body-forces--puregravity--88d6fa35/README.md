# jeff97-programming-plane-strain-plates-through-growth-under-body-forces--puregravity--88d6fa35

`Jeff97__Programming-Plane-Strain-Plates-through-Growth-Under-Body-Forces/Examples-In-Section-3/ArcDown/Th002/PureGravity.for`
...
- **Stress and state history**: agreed to 2.768e-09 on stress and 0.000e+00 on state, over 2060 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 4 of 4 states along the loading path, worst 5.082e-09.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 0 | 1 | 4.181e-09 | agreed |
| 9 | 10 | 3.643e-09 | agreed |
| 22 | 3 | 1.821e-09 | agreed |
| 91 | 12 | 5.082e-09 | agreed |
