# jeff97-programming-plane-strain-plates-through-growth-under-body-forces--puregravity--53b3211f

`Jeff97__Programming-Plane-Strain-Plates-through-Growth-Under-Body-Forces/Examples-In-Section-4/Experiment-ECOFLEX0030-ArcDown/Th01/PureGravity.for`
...
- **Stress and state history**: agreed to 1.255e-08 on stress and 0.000e+00 on state, over 2032 resolved components.
- **OTI tangent against a finite difference of the ORIGINAL**: agreed at 4 of 4 states along the loading path, worst 1.937e-08.

| state | increment | best relative | verdict |
| --- | --- | --- | --- |
| 0 | 1 | 9.686e-09 | agreed |
| 9 | 10 | 1.937e-08 | agreed |
| 22 | 3 | 1.249e-08 | agreed |
| 91 | 12 | 1.221e-08 | agreed |
