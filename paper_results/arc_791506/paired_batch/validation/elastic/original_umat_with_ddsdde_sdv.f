...
C
      ...
      STATEV(8) = DDSDDE(2,3)
      STATEV(9) = DDSDDE(2,4)
      STATEV(10) = DDSDDE(3,1)
      STATEV(11) = DDSDDE(3,2)
      STATEV(12) = DDSDDE(3,3)
      STATEV(13) = DDSDDE(3,4)
      STATEV(14) = DDSDDE(4,1)
      STATEV(15) = DDSDDE(4,2)
      STATEV(16) = DDSDDE(4,3)
      STATEV(17) = DDSDDE(4,4)
