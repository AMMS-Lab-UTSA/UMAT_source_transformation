...
C
      ...
      STATEV(8) = DDSDDE(1,2)
      STATEV(9) = DDSDDE(1,3)
      STATEV(10) = DDSDDE(1,4)
      STATEV(11) = DDSDDE(1,5)
      STATEV(12) = DDSDDE(1,6)
      STATEV(13) = DDSDDE(2,1)
      STATEV(14) = DDSDDE(2,2)
      STATEV(15) = DDSDDE(2,3)
      STATEV(16) = DDSDDE(2,4)
      STATEV(17) = DDSDDE(2,5)
      STATEV(18) = DDSDDE(2,6)
      STATEV(19) = DDSDDE(3,1)
      STATEV(20) = DDSDDE(3,2)
      STATEV(21) = DDSDDE(3,3)
      STATEV(22) = DDSDDE(3,4)
      STATEV(23) = DDSDDE(3,5)
      STATEV(24) = DDSDDE(3,6)
      STATEV(25) = DDSDDE(4,1)
      STATEV(26) = DDSDDE(4,2)
      STATEV(27) = DDSDDE(4,3)
      STATEV(28) = DDSDDE(4,4)
      STATEV(29) = DDSDDE(4,5)
      STATEV(30) = DDSDDE(4,6)
      STATEV(31) = DDSDDE(5,1)
      STATEV(32) = DDSDDE(5,2)
      STATEV(33) = DDSDDE(5,3)
      STATEV(34) = DDSDDE(5,4)
      STATEV(35) = DDSDDE(5,5)
      STATEV(36) = DDSDDE(5,6)
      STATEV(37) = DDSDDE(6,1)
      STATEV(38) = DDSDDE(6,2)
      STATEV(39) = DDSDDE(6,3)
      STATEV(40) = DDSDDE(6,4)
      STATEV(41) = DDSDDE(6,5)
      STATEV(42) = DDSDDE(6,6)
